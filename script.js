...
function viewType2() {
  if (!document.getElementById("seller-p").value == "") {
    if (PasswordVeiwType1 == true) {
      ...
      document.getElementById("seller-icon1").className =
  ...
  request.onreadystatechange = function () {
    if (request.readyState == 4) {
      ...
      if (
        ...
        txt == "First Name must have less than 50 characters ???"
      ) {
        ...
        txt == "Last Name must have less than 50 characters ???"
      ) {
        ...
        txt == "Email must have less than 100 characters ???"
      ) {
        lname.className = "form-control";
        fname.className = "form-control";
        password.className = "form-control";
        ...
        txt == "Password must be between 5 - 20 charcters ???"
      ) {
        lname.className = "form-control";
        fname.className = "form-control";
        email.className = "form-control";
        ...
        txt == "Mobile Number must have 10 characters"
      ) {
        fname.className = "form-control";
        lname.className = "form-control";
        email.className = "form-control";
        ...
        msg.innerHTML = "&nbsp; &nbsp;" + txt;
        document.getElementById("errormsgBox1").className =
  ...
  request.onreadystatechange = function () {
    if (request.readyState == 4) {
      ...
      if (
        ...
        text == "Password must be between 5 - 20 charcters ???"
      ) {
        ...
        document.getElementById("errorMassage").className =
...
function sendVcode() {
  ...
  request.onreadystatechange = function () {
    if (request.readyState == 4) {
      ...
      document.getElementById("fclosebtn").className =
...
function CodeVerify() {
  ...
  request.onreadystatechange = function () {
    if (request.readyState == 4) {
      ...
      document.getElementById("fploader").className = "btn btn-primary d-none";
      if (
        txt == "Enter Your Verificaton Code ???" ||
        txt == "Invalid Verification Code ???"
      ) {
        ...
        document.getElementById("vAlert").className =
  ...
  request.onreadystatechange = function () {
    if (request.readyState == 4) {
      ...
      if (text == "Enter new Password ???") {
        ...
        newPassword.className = "form-control";
        CnewPassword.className = "form-control";
        document.getElementById("fperrormsg2").className =
          "alert alert-danger d-none";
...
function sidemenu() {
  document.getElementById("menuSideUp").className =
    "side-main-menu1 mt-5 pt-1 col-6 col-md-4 col-lg-4 col-xl-3 ps-5";
  document.getElementById("menuSide").className =
    "sidemain2 col-8 col-md-6 col-lg-4 col-xl-3 shadow-lg";
}

function closesideMenu() {
  document.getElementById("menuSide").className =
    "sidemain1 col-8 col-md-6 col-lg-4 col-xl-3 shadow-lg";
}

function upmenu() {
  document.getElementById("menuSideUp").className =
    "side-main-menu2 mt-4 pt-1 col-6 col-md-4 col-lg-4 col-xl-3 ps-5";
  document.getElementById("menuSide").className =
    "sidemain1 col-8 col-md-6 col-lg-4 col-xl-3 shadow-lg";
}
...
function upmenuClose() {
  document.getElementById("menuSideUp").className =
    "side-main-menu1 mt-4 pt-1 col-6 col-md-4 col-lg-4 col-xl-3 ps-5";
}

function showserachBar() {
  document.getElementById("showbar").className =
    "col-12 bg-light searchmainBox2";
}

function closeserachBar() {
  document.getElementById("productitemlist").className =
    "col-12 p-3 rounded shadow-sm bg-light d-none";
  document.getElementById("showbar").className =
    "col-12 bg-light searchmainBox1";
}
  ...
  if (searchtext.value.length == 0) {
    ...
    r.onreadystatechange = function () {
      if (r.readyState == 4) {
        ...
        document.getElementById("productitemlist").className =
          "col-12 p-3 rounded shadow-sm bg-light";
      }
    };
  ...
  rq.onreadystatechange = function () {
    if (rq.readyState == 4) {
      ...
      if (txt == "Success") {
        ...
        document.getElementById("viewImg").className =
          "rounded-3 mt-5 border border-danger";
...
function nicupload() {
  ...
  imgchooser.onchange = function () {
    ...
    if (file_count == 2) {
      document.getElementById("nicmaindiv1").className =
        "col-5 border border-2 border-dark d-flex justify-content-center";
      document.getElementById("nicmaindiv2").className =
        "col-5 border border-2 border-dark d-flex justify-content-center";
      ...
      document.getElementById("nicmaindiv1").className =
        "col-5 border border-2 border-danger d-flex justify-content-center";
      document.getElementById("nicmaindiv2").className =
        "col-5 border border-2 border-danger d-flex justify-content-center";
...
function CreateSeller() {
  ...
  rq.onreadystatechange = function () {
    if (rq.readyState == 4) {
      ...
      if (
        txt == "Enter Your New Seller Email ???" ||
        txt == "Email must have lessthan 100 charactors ???"
      ) {
        // seller new password
        document.getElementById("sellernewpasswordinput").className =
        ...
        document.getElementById("sellerConformPInput").className =
          "form-control shadow-none";
        ...
        // seller NIC
        // seller shop Name
        document.getElementById("shop_name").className =
          "form-control shadow-none";
        document.getElementById("shop_field").innerHTML = txt;
        document.getElementById("shop_field").className =
          "invalid-field d-none";
        // seller shop Name
        // NIC Images
        document.getElementById("nicmaindiv1").className =
          "col-5 border border-2 border-dark d-flex justify-content-center";
        ...
        txt == "Enter New Seller Password ???" ||
        txt == "Password must have between 5 - 20 charactors ???"
      ) {
        // seller new password
        document.getElementById("sellernewpasswordinput").className =
        ...
        txt == "Enter Your Conform Seller Password ???" ||
        txt == "Password Does Not Matched ???"
      ) {
        // seller new password
        document.getElementById("sellernewpasswordinput").className =
          "form-control shadow-none";
        ...
        // seller Confirm Password
        // seller NIC
        document.getElementById("s_nic").className =
          "form-control shadow-none is-invalid";
        document.getElementById("nic_field").innerHTML = txt;
        ...
        txt == "Enter Your Shop Name ???" ||
        txt == "Shop Name Must Have between 5 - 20 Charactors ???"
      ) {
        // seller new password
        document.getElementById("sellernewpasswordinput").className =
          "form-control shadow-none";
        ...
        txt == "Invalid Image Type ???" ||
        txt == "Invalid Image Count ???"
      ) {
        // seller new password
        document.getElementById("sellernewpasswordinput").className =
          "form-control shadow-none";
        ...
        txt == "Admin will Cornform Your Seller Email Account Request"
      ) {
        // seller new password
        document.getElementById("sellernewpasswordinput").className =
          "form-control shadow-none";
        ...
        document.getElementById("request_note").innerHTML =
          "We Are Send Your Request To Admin <br/> & <br/> Admin is Approve Your Create Seller Account Request After You Can Access Your Seller Account";
        document.getElementById("sellerPage_content").className =
          "col-11 rounded-3 mb-4 shadow-lg d-none";
      } else {
        alert(txt);
      }
    }
  ...
  r.onreadystatechange = function () {
    if (r.readyState == 4) {
      ...
      if (txt == "Enter Your NIC Number ???") {
        document.getElementById("seller_signIn-e").className =
          "form-control shadow-none is-invalid";
        document.getElementById("signup-msgseller2").innerHTML =
          "&nbsp;&nbsp;" + txt;
        document.getElementById("errormsgseller1").className = "col-12";
      } else if (txt == "Enter Your Password ???") {
        document.getElementById("seller_signIn-e").className =
          "form-control shadow-none";
        document.getElementById("seller_signIn-p").className =
          "form-control shadow-none is-invalid";
        document.getElementById("signup-msgseller2").innerHTML =
          "&nbsp;&nbsp;" + txt;
        document.getElementById("errormsgseller1").className = "col-12";
        ...
        document.getElementById("sellercontent").className =
          "container-fluid vh-100 d-flex justify-content-center background-decoration-02 d-none";
        document.getElementById("sellererrorMassage").className =
          "w-100 vh-100 d-flex align-items-center justify-content-center";
      } else {
        alert(txt);
      }
...
function sellerFilterShow() {
  document.getElementById("s_filter").className =
    "col-6 col-md-4 col-lg-3 col-xxl-2 pe-3 vh-100 d-flex align-items-center fixed-top bg-transparent fiterSlideshow";
}

function sellerFilterHide() {
  document.getElementById("s_filter").className =
    "col-6 col-md-4 col-lg-3 col-xxl-2 pe-3 vh-100 d-flex align-items-center fixed-top bg-transparent fiterSlidehidden";
}
  ...
  rq.onreadystatechange = function () {
    if (rq.readyState == 4) {
      ...
      if (txt == "empty") {
        ...
        document.getElementById("addImg1").className =
          "col-12 col-lg-2 border border-2 mx-2 d-flex justify-content-center border-danger";
        document.getElementById("addImg2").className =
          "col-12 col-lg-2 border border-2 mx-2 d-flex justify-content-center border-danger";
        document.getElementById("addImg3").className =
          "col-12 col-lg-2 border border-2 mx-2 d-flex justify-content-center border-danger";
        document.getElementById("addImg4").className =
          "col-12 col-lg-2 border border-2 mx-2 d-flex justify-content-center border-danger";
      } else if (txt == "success") {
        p_category.className = "form-select shadow-none";
        p_brand.className = "form-select shadow-none";
        ...
        document.getElementById("addImg1").className =
          "col-12 col-lg-2 border border-2 mx-2 d-flex justify-content-center";
        document.getElementById("addImg2").className =
          "col-12 col-lg-2 border border-2 mx-2 d-flex justify-content-center";
        document.getElementById("addImg3").className =
          "col-12 col-lg-2 border border-2 mx-2 d-flex justify-content-center";
        ...
        document.getElementById("toastCbody").innerText =
...
function seeproductSize() {
  ...
  r.onreadystatechange = function () {
    if (r.readyState == 4) {
      var t = r.responseText;
      if (t == "Have Sizes") {
        document.getElementById("p_size_field").className =
          "col-6 col-lg-3 border-end mt-3 mb-3";
        document.getElementById("p_field").className =
          "col-6 col-lg-3 border-end mt-3 mb-3";
        document.getElementById("dc_field1").className =
          "col-6 col-lg-3 border-end mt-3 mb-3";
        document.getElementById("dc_field2").className =
          "col-6 col-lg-3 mt-4 mt-lg-2 mb-3 pt-2";
        document.getElementById("a_dw_cost").className =
          "form-control mt-4 mt-lg-0";
      } else if (t == "Havent Sizes") {
        document.getElementById("p_size_field").className =
          "col-6 col-lg-3 border-end mt-3 mb-3 d-none";
        document.getElementById("p_field").className =
          "col-6 col-lg-4 border-end mt-3 mb-3";
        document.getElementById("dc_field1").className =
          "col-6 col-lg-4 border-end mt-3 mb-3";
        document.getElementById("dc_field2").className =
          "col-10 col-lg-4 mt-0 mt-lg-3 mb-3 offset-1 offset-lg-0";
      }
    }
  };
    ...
    if (r.readyState == 4) {
      ...
      if (t == "Invalid Image Count") {
        ...
        document.getElementById("img1").className =
          "col-12 col-lg-2 border border-danger border-2 mx-2 d-flex justify-content-center";
...
function ProductActive(number, pid) {
  ...
  rq.open(
    "GET",
    "productActiveProcess.php?c=" + active_number + "&id=" + pid,
    true
  );
  rq.send();
}
...
async function convertCurrency(lkrAmount) {
  if (!lkrAmount) {
    alert("Please enter an amount in LKR");
    return;
  }
  ...
  try {
    ...
    // Extract the USD conversion rate
...
function saveInvoice(orderId, id, user_email, amount, qty, shipping) {
  var form = new FormData();
...
function saveCartInvoice(orderId, amount, shipping) {
  var form = new FormData();
  form.append("o", orderId);
  form.append("a", amount);
  form.append("s", shipping);
...
function addToCart(id) {
  ...
  r.onreadystatechange = function () {
    if (r.readyState == 4) {
      var t = r.responseText;
      if (
        t == "Successfully Update This Product Quentity" ||
        t == "Allready Applied Maximum Quentity" ||
        t == "Successfully Insert From Cart"
      ) {
...
function SearchPRoductfilter() {
  ...
  // condition
  if (
    document.getElementById("Bn").checked &&
...
function showSize() {
  if (document.getElementById("p_category").value == 2) {
    document.getElementById("siziDiv").className =
      "col-4 col-md-3 mt-3 border-end";
    document.getElementById("SearchbarDIV").className =
      "col-9 col-md-6 offset-3 offset-md-3 mt-3 mt-md-5";
  }
}
...
function addToWatchList(id) {
  ...
  r.onreadystatechange = function () {
    if (r.readyState == 4) {
      ...
      if (
        t == "Successfully add to Watchlist ...." ||
        t == "This Product Already Exist In Watchlist ...."
      ) {
        document.getElementById("toastCbody").innerHTML = t;
        const toastLiveExample = document.getElementById("liveToast");
        const toast = new bootstrap.Toast(toastLiveExample);
...
function Sblock_Unblock_Users(nic) {
  ...
  r.onreadystatechange = function () {
    if (r.readyState == 4) {
      var t = r.responseText;
      if (t == "Deactived") {
        document.getElementById("seller_b&Ubtn" + nic).className =
          "btn btn-success";
...
function block_Unblock_Product(id) {
  ...
  r.onreadystatechange = function () {
    if (r.readyState == 4) {
      var t = r.responseText;
      if (t == "Deactived") {
        document.getElementById("Productb&Ubtn" + id).className =
          "btn btn-success";
  ...
  r.onreadystatechange = function () {
    if (r.readyState == 4) {
      ...
      if (t == 0) {
        ...
        document.getElementById("btn" + inID).className =
          "btn btn-success fw-bold mt-1 mb-1";
      } else if (t == 1) {
        document.getElementById("btn" + inID).innerHTML = "Packing";
        document.getElementById("btn" + inID).className =
          "fw-bold mt-1 mb-1 btn btn-warning";
      } else if (t == 2) {
...
function sellerforgotPasswordModel() {
  ...
  r.onreadystatechange = function () {
    if (r.readyState == 4) {
      ...
      if (
        t == "invalid NIC No ???" ||
        t == "Verification code sending failed ???"
      ) {
        document.getElementById("alertTextSeller").innerHTML = t;
        document.getElementById("alertsellerforgot").className =
          "alert alert-danger mt-2";
      } else if (t == "Verification Code Successfully Send Your User Email") {
        document.getElementById("alertsellerforgot").className =
          "alert alert-danger mt-2 d-none";
        document.getElementById("showSellerverifyNIC").className =
          "btn btn-primary d-none";
        document.getElementById("showSellerverificationCode").className =
          "btn btn-primary";
...
function sellerverificationCode() {
  ...
  r.onreadystatechange = function () {
    if (r.readyState == 4) {
      var t = r.responseText;
      if (t == "success") {
        document.getElementById("mainsellermDIV").className =
          "modal-body d-none";
        ...
        t == "Enter Passwords ????" ||
        t == "Password Should Have Between 5-20 Charactors ????"
      ) {
        document.getElementById("alertTextSeller").innerHTML = t;
        document.getElementById("alertsellerforgot").className =
          "alert alert-danger mt-2";
      } else if (
        t == "Password Does Not Matched ????" ||
...
function addCategoryType() {
  var ct_name = document.getElementById("ctId").value;

  var form = new FormData();
  form.append("ct", ct_name);
  ...
  r.onreadystatechange = function () {
    if (r.readyState == 4) {
      ...
      if (response == 1) {
        document.getElementById("toastCbody").innerHTML =
          "Category Type Successfully Addedd";
        const toastLiveExample = document.getElementById("liveToast");
        const toast = new bootstrap.Toast(toastLiveExample);
        toast.show();
        setTimeout(() => {
        ...
        document.getElementById("toastCbody").innerHTML = response;
        const toastLiveExample = document.getElementById("liveToast");
        const toast = new bootstrap.Toast(toastLiveExample);
        toast.show();
        setTimeout(() => {
  ...
  r.open("POST", "addCategoryType.php", true);
  r.send(form);
}

function addCategory() {
  var ct_name = document.getElementById("selectCategoryType").value;
  var c_name = document.getElementById("cId").value;

  var form = new FormData();
  form.append("c", c_name);
  form.append("ct", ct_name);
...
function addBrand() {
  var b_name = document.getElementById("bId").value;

  var form = new FormData();
  form.append("b", b_name);
  ...
  r.onreadystatechange = function () {
    if (r.readyState == 4) {
      ...
      if (response == 1) {
        ...
        document.getElementById("toastCbody").innerHTML = "Brand Already Exist";
        const toastLiveExample = document.getElementById("liveToast");
        const toast = new bootstrap.Toast(toastLiveExample);
        toast.show();
        setTimeout(() => {
...
function addModel() {
  var m_name = document.getElementById("mId").value;

  var form = new FormData();
  form.append("m", m_name);
  ...
  r.onreadystatechange = function () {
    if (r.readyState == 4) {
      ...
      if (response == 1) {
        ...
        document.getElementById("toastCbody").innerHTML = "Model Already Exist";
        const toastLiveExample = document.getElementById("liveToast");
        const toast = new bootstrap.Toast(toastLiveExample);
        toast.show();
        setTimeout(() => {
...
function addModelBrandConnection() {
  var m_id = document.getElementById("selectModelId").value;
  var b_id = document.getElementById("selectBrandId").value;
  ...
  r.onreadystatechange = function () {
    if (r.readyState == 4) {
      ...
      if (response == 1) {
        document.getElementById("toastCbody").innerHTML =
          "Connection Successfully Addedd";
        const toastLiveExample = document.getElementById("liveToast");
        const toast = new bootstrap.Toast(toastLiveExample);
        toast.show();
        setTimeout(() => {
        ...
        document.getElementById("toastCbody").innerHTML = "Connection Already Exist";
        const toastLiveExample = document.getElementById("liveToast");
        const toast = new bootstrap.Toast(toastLiveExample);
        toast.show();
        setTimeout(() => {
  ...
  r.open("POST", "addModelBrand.php", true);
  r.send(form);
}
