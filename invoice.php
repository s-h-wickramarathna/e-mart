                    ...
                    <div class="col-12">
                        <div class="row mt-2">
                            ...
                            <div class="col-4 text-end">
                                <p class="m-0 fs-5 fw-bold text-primary">INVOICE NO : <?php echo ($invoice_data["invoice_id"]) ?></p>
                        ...
                        <div class="row">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col" class="bg-secondary text-white">Order Id</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row" class="bg-secondary text-white"><?php echo ($invoice_data["order_id"]) ?></th>
                                            <td class="bg-info text-white"><?php echo ($invoice_data["title"]) ?></td>
                                            <td class="bg-secondary text-white"><?php echo ($invoice_data["nic"]) ?></td>
                            ...
                            <div class="col-12 mt-2">
                                <div class="row text-end">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <p class="m-0 mt-2"><span class="fs-5 fw-bold text-primary">SUB TOTAL </span>LKR : <?php echo ($g) ?>.00 </p>
                                            <p class="m-0 mt-2"><span class="fs-5 fw-bold text-primary">DELIVARY FEE </span>LKR : <?php echo ($delivar_fee) ?>.00 </p>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="row fw-bold">
                                                <p class="m-0"><span class="fs-5 fw-bold text-primary">GRAND TOTAL </span>LKR : <?php echo ($t) ?>.00 </p>
                                            </div>
                                        </div>
                                        <div class="col-4 offset-8">
